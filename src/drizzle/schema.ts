...
export type TILocationAndBranch = typeof LocationAndBranchesTable.$inferInsert;
export type TSLocationAndBranch = typeof LocationAndBranchesTable.$inferSelect;
