...
export const listCustomerSupportTicket = async (c) => {
    try {
...
export const getCustomerSupportTicket = async (c) => {
...
export const createCustomerSupportTicket = async (c) => {
    try {
...
export const updateCustmerSupportTicket = async (c) => {
    const id = parseInt(c.req.param("id"));
    if (isNaN(id))
        return c.text("Invalid ID", 400);
    const CustomerSupportTicket = await c.req.json();
...
export const deleteCustomerSupportTicket = async (c) => {
